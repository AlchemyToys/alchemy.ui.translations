module.exports = {
  ...
  action_sacrifice: "Opfern",
  action_enlighten: "Erleuchtung",
  action_ascend: "Himmelfahrt",
  action_back_toys: "Zurück zum TOYS Deck",
  nav_favorites: "Favoriten",
  nav_dashboard: "Dashboard",
  nav_deck: "Mein TOYS Deck",
  nav_gods: "Alchemiegötter",
  nav_explore: "Erkunden",
  nav_treasury: "Tempelschatz",
  nav_marketplace: "Marktplatz",
  nav_vault: "Schamanengewölbe",
  nav_exchange: "GAT Tausch",
  ...
  nav_legal: "Haftungsausschluss",
  cookie_msg:
    "Diese Website verwendet Cookies, um die Benutzererfahrung zu optimieren!",
  cookie_accept: "Ich verstehe",
  connect: "Verbinden",
  game_turn: "{{count}} Spielzug",
  game_turn_plural: "{{count}} Spielzüge",
  time_now: "jetzt",
  time_in: "in",
  time_cycle_epoch: "Periode / Epoche",
  time_current_epoch: "Aktuelle Epoche",
  time_next_cycle: "Nächste Periode beginnt",
  last_actions: "Letzte Spielzüge",
  your_balances: "Deine Guthaben",
  balance: "Guthaben",
  balance_GAT: "GAT Guthaben",
  balance_TOYS: "TOYS Token",
  contract_addresses: "Smart Contract Addressen",
  contract_addresses_subheader: "das ist die einzige Quelle der Wahrheit",
  contract_game: "Alchemy Toys Spiel",
  contract_toys: "Alchemy TOYS Token",
  contract_treasury: "Alchemy Toys Tempelschatz",
  contract_timer: "Spiel-Timer",
  contract_gat: "Game Ace Token",
  contract_vault: "Schamanengewölbe",
  contract_gmx: "Game Ace Token Tauschplatz",
  cta_ready: "Bereit einzutauchen?",
  cta_test: "Probier das Spiel aus!",
  cta_description:
    "Wechsel zunächst ins Binance Test-Netzwerk und teste das vollständige Spiel noch heute!",
  cta_link_metamask: "MetaMask Binance Installationsanweisungen",
  ...
  favorites_no_toys: "Du hast noch keine TOYS in deinen Favoriten",
  toys_collection: "Meine Sammlung",
  toys_series: "Seriennummern",
  toys_stat_my: "Meine TOYS",
  ...
  toys_collection_button_worship: "Zur Anbetungskammer",
  collection_order: "Reihenfolge",
  collection_order_newest: "Neuste zuerst",
  collection_order_oldest: "Älteste zuerst",
  collection_order_serial_asc: "Seriennummer aufsteigend",
  collection_order_serial_desc: "Seriennummer absteigend",
  collection_order_type_asc: "TOYS Typ aufsteigend",
  collection_order_type_desc: "TOYS Typ absteigend",
  collection_list_filters: "Filter",
  collection_list_view: "Als Liste anzeigen",
  collection_list_all: "Alle",
  collection_list_special: "Spezielle Token",
  status_not_sacrificed: "Nicht geopfert",
  toys_selected: "Ausgewählte TOYS",
  toys_not_selected: "Nicht ausgewählte TOYS",
  toys_not_favorites: "Nicht Favoriten",
  ...
  connect_wallet_button: "Verbinde zuerst dein Wallet!",
  ...
  toys_melt_recipe_new_description:
    "Wenn du dieses TOYS verschmelzt, erhältst du als Belohnung ein TOYS aus einer niedrigeren Ebene!",
  toys_melt_select: "Wähle TOYS zum verschmelzen aus!",
  toys_melt_select_description:
    "Du musst genau zwei TOYS aus deiner Sammlung auswählen.",
  toys_select_button: "Jetzt auswählen",
  toys_melt_doc: `
 Wenn du diese TOYS Token verschmilzt, erhältst du
          <1> ein neues TOYS Token einer höheren Ebene! </1> Wenn du zwei TOYS verschiedener
          Ebenen verschmilzt, wird die Ebene des neuen TOYS eine höher als der Durchschnitt der
          zwei Ebenen sein (abgerundet). Verschmelzen kostet dich
  ...
  toys_enlightenment_check: "Meine Erleuchtung überprüfen",
  toys_select_sacrifice: "Wähle TOYS zum Opfern aus!",
  toys_select_sacrifice_description:
    "Du musst wenigstens ein TOYS Token aus deiner Sammlung auswählen.",
  toys_unselect_subheader: "bitte abwählen!",
  toys_unselect_header: "Diese TOYS können nicht geopfert werden",
  toys_unselect_button: "Problematische TOYS abwählen",
  ...
  toys_serial_doc_2: `
  TOYS mit
            <1> einer kleineren Seriennummer (= ältere TOYS) sind wertvoller</1> wenn diese geopfert werden.
            Ein erleuchteter Spieler (der alle TOYS-Typen geopfert hat)
            erhält einen proportionell <3>höheren Anteil am Gewinn</3> während des Himmelfahrt-Rituals.
  `,
  ...
  enlightenment_si_description: `
    ...
    Wenn der Opfer-Index von Spieler B <27></27> = <30>250</30> gewesen wäre,
    ändert sich sein Anteil auf <33>(1250-250)/1250</33> = <36>80%</36>.
    Ältere TOYS haben also einen Zeitwert und werden schnell wertvoller, weil sie
    einen höheren Anteil am Schatz bedeuten!</1>
    <2>
    Wenn es in der aktuellen Epoche bereits mindestens einen Erleuchteten gibt, wird auf dieser Seite
    oben "Erleuchtete"-Tab angezeigt, zusammen mit den jeweiligen <2></2> Opfer-Index,
    sodass du dementsprechend handeln kannst.</2>
  `,
  enlightenment_my_sacrifices: "Meine Opfer",
  enlightenment_enlightened_list: "Liste der Erleuchteten",
  gods_history: "Geschichte der Götter",
  prophet_reward: "Belohnung Prophet",
  prophet_confirmation: "Danke, dass du Prophet warst!",
  prophet_confirmation_doc:
    "Sobald die Transaktion bestätigt ist, wechselt die Epoche! Und du wirst reichlich belohnt!",
  ...
  olymp_description:
    "Dies ist der Olymp der Alchemie-Götter - eine Geschichte der Erleuchteten und Aufgestiegenen!",
  gods_error: "Es sind noch keine Götter bekannt!",
  gods_error_doc:
    "Vielleicht wirst Du zu einem Alchemie-Gott? Warum nicht deinen Weg der Erleuchtung beginnen, indem du neue TOYS sammelst und diese opferst?",
  explore_input_error:
    "Deine Eingabe scheint keine gültige Adresse oder Token-ID zu sein!",
  search: "Suche",
  search_placeholder: "Suche nach Adresse or Token-ID",
  go_to_market: "Zum Marktplatz",
  market_for_sale: "Zum Verkauf auf dem Marktplatz",
  address_details: "Übersicht Adresse",
  address_error: "Ungültige Adresse",
  address_error_doc:
    "Diese Adresse scheint ungültig zu sein. Prüfe bitte deine Angabe!",
  ...
  token_send: "Token senden",
  token_send_placeholder: "Adresse des Begünstigten",
  name: "Name",
  serial_number: "Seriennummer",
  status: "Status",
  status_active: "Aktiv im Spiel",
  status_sacrificed: "Geopfert",
  status_404: "Existiert nicht",
  nft_market: "NFT Marktplatz",
  nft_market_link: "Diesen Token auf dem NFT Marktplatz anschauen",
  owner: "Halter",
  ...
  `,
  enlightened_plural: "Erleuchteten",
  shamans_plural: "Schamanen",
  prophet: "Prophet",
  ...
  `,
  gat_input: "Gib einen {{currency}} Betrag ein",
  gat_input_doc: "Betrag, den du umtauschen möchtest",
  gat_calc: "Du erhältst ugf. so viele GAT",
  gat_avg: "Durchschnittspreis je GAT",
  gat_button: "Umtausch {{currency}} für GAT",
  shaman_payout_button: "Meine Belohnung auszahlen",
  shaman_payout: "Auszahlung erfolgreich!",
  shaman_payout_doc:
    "Sobald die Transaktion genehmigt wurde, solltest du in deinem Konto mehr {{currency}} sehen!",
  shaman_payout_ok: "erfolgreich entsperrt!",
  shaman_payout_ok_doc:
    "Sobald die Transaktion genehmigt wurde, sollte das GAT in Ihrem Konto angezeigt werden.",
  shaman_lock_ok: "Erfolgreich gesperrt!",
  shaman_lock_ok_doc:
    "Sobald die Transaktion genehmigt wurde, sollte deine GAT-Freigabe im Tresor angezeigt werden.",
  shaman_unlock: "Mein GAT komplett entsperren",
  vault_stats: "Tresor-Statistiken",
  vault_my_stats: "Meine Tresorstatistiken",
  vault_balance: "Tresor GAT Kontostand",
  vault_my_balance: "Mein gesperrter GAT-Kontostand",
  vault_my_balance_share: "{{share}}%",
  vault_eligible_start: "Berechtigte Startepoche",
  vault_total_payable: "Auszahlbare Belohnung",
  shamans_share: "Schamanenanteil Tempelschatz",
  shamans_doc: `
  ...
  <1>Wenn du GAT in den Tresor einschließt, hast du das Recht,
  ab der nächsten Epoche an den Belohnungsauszahlungen der Schamanen teilzunehmen.
  Die <2>"berechtigte Startepoche"</2>
  gibt an, ab welcher Epoche du für Belohnungen berechtigt bist. Natürlich muss mindestens
  ein GAT gesperrt sein, um an den Belohnungen teilnehmen zu können.</1>
  
  <2>Wenn du eine Auszahlung beantragst, werden alle Prämienanteile aus allen vergangenen
  berechtigten Epochen auf dein Konto ausgezahlt. Die "berechtigte Startepoche" wird dann
  auf die aktuelle Epoche gesetzt, sodass du für die aktuelle Epoche ab der nächsten Epoche
  wieder deine Belohnung erhalten kannst.
  </2>
  
  <3><0></0> Die Änderung des gesperrten Betrages, ändert die berechtigte Startepoche!</3>
  
  <4>Wenn du mehr GAT hinzufügst, wird die berechtigte Epoche auf die nächste Epoche gesetzt.</4>
  ...
  `,
  shamans_lock_header: "Mehr GAT sperren",
